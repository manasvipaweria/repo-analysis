...
# I will just write a python script to replace the large extraction block.
# Finding: Category.SECURITY.value -> Category.PRIVACY.value for gdpr stuff
...
with open("patch_orch_2.py", "w", encoding="utf-8") as f:
    f.write(script)
